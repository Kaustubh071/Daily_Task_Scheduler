...
public class Registration extends JFrame implements ActionListener   {
   JLabel l1, l2, l3, l4, l5, l6, l7, l8;  
    ...
    {  
        ...
        l4 = new JLabel("Create Passoword:");  
    ...
    {  
        if (e.getSource() == btn1)  
         {  
            ...
            {  
                ...
                {  
                   ...
                   addData(s1,s8,s2,s5,s6,s7);
                        ...
                        JOptionPane.showMessageDialog(btn1, "User Successfully Registered!!!");
                        closeSignUpWindow();
                        new Login();
                }  
                catch (Exception ex)   
            ...
            {  
                JOptionPane.showMessageDialog(btn1, "Confirm Password and Create Password Does Not Match");  
            }   
          }   
          else  
          {  
